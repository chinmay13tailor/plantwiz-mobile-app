...
class _LoginPageState extends TbPageState<LoginPage>
                              ...
                              child: IntrinsicHeight(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Align(
                                      alignment: Alignment.center,
                                      child: tbContext.wlService.loginLogoImage != null
                                          ? SizedBox(
                                        height: 120,
                                        width: 200,
                                        child: tbContext.wlService.loginLogoImage,
                                      )
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              OutlinedButton(
                                                ...
                                                onPressed: () async =>
                                                await _onLoginWithBarcode(context),
                                                child: Row(
                                                  children: [
                                                    SvgPicture.asset(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            ValueListenableBuilder(
                                              ...
                                              builder:
                                                  (BuildContext context, bool showPassword, child) {
  ...
  Widget _buildOAuth2Buttons(List<OAuth2ClientInfo> clients) {
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            ...clients.asMap().map((index, client) =>
                MapEntry(
                  index,
                  _buildOAuth2Button(
                    client,
  ...
  Widget _buildOAuth2Button(OAuth2ClientInfo client, bool expand, bool isLast) {
    ...
    icon ??=
        Icon(Icons.login, size: 24, color: Theme.of(context).primaryColor);
